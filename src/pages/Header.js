...
function Header() {
  ...
  return (
    ...
    {open ? <HeaderContent><HeaderText><BoxTitle>{AboutTitle}</BoxTitle><br/>It has been placed here solely to demonstrate the look and feel<br/> of finished, typeset text and its only for show so she who <br/>searches for meaning here will be solely disappointed.</HeaderText></HeaderContent>: true}
    {open === false ? <HeaderContent><HeaderText><BoxTitle>{ProgramTitle}</BoxTitle><br/>It has been placed here solely to demonstrate the look and feel<br/> of finished, typeset text and its only for show so she who <br/>searches for meaning here will be solely disappointed.</HeaderText><HeaderContentImage src={gathering} alt="Logo of Black in AI"/></HeaderContent>: true}
